...
var _paint = __webpack_require__(18);

var _paint2 = _interopRequireDefault(_paint);

var _ripple = __webpack_require__(19);

var _wolfy87Eventemitter = __webpack_require__(0);
...
var extract = function extract(object) {
    return (0, _lodash2.default)(object, function (item) {
 ...
 * @return {EventEmitter}
 */
var MdColorPicker = exports.MdColorPicker = function MdColorPicker(_ref) {
    ...
    var materialColors = extract((0, _lodash4.default)(_colors2.default, omitedColors));
    ...
    var toggle = function toggle() {
        if (container.getAttribute("class") === "color-container") container.setAttribute("class", "color-container-open");else container.setAttribute("class", "color-container");
        return false;
    };
...
var Grid = exports.Grid = function Grid(element, colors, ee) {
  ...
  close.addEventListener("click", function () {
    return window.dispatchEvent(new Event("grid_closed"));
  });
...
class MDCRipple extends __WEBPACK_IMPORTED_MODULE_0__material_base__["a" /* MDCComponent */] {
  ...
  static createAdapter(instance) {
    const MATCHES = __WEBPACK_IMPORTED_MODULE_2__util__["getMatchesProperty"](HTMLElement.prototype);

    return {
      browserSupportsCssVars: () => __WEBPACK_IMPORTED_MODULE_2__util__["supportsCssVariables"](window),
      ...
      registerInteractionHandler: (evtType, handler) =>
          instance.root_.addEventListener(evtType, handler, __WEBPACK_IMPORTED_MODULE_2__util__["applyPassive"]()),
      deregisterInteractionHandler: (evtType, handler) =>
          instance.root_.removeEventListener(evtType, handler, __WEBPACK_IMPORTED_MODULE_2__util__["applyPassive"]()),
...
class MDCRippleFoundation extends __WEBPACK_IMPORTED_MODULE_0__material_base__["b" /* MDCFoundation */] {
  ...
  getFgTranslationCoordinates_() {
    ...
    if (wasActivatedByPointer) {
      startPoint = __WEBPACK_IMPORTED_MODULE_2__util__["getNormalizedEventCoords"](
